...
public class ProductController {
	...
	public ResponseEntity<String> show(){
		return new ResponseEntity("Show Method ",HttpStatus.CREATED);
	}
	...
	@PostMapping("/addData")
	public ResponseEntity<String> addProduct(@ModelAttribute Product p){
	...
	public ResponseEntity<String> addProduct1(@RequestBody Product p){
		productService.addnewProduct(p);
		return new ResponseEntity("Data Added Sucessfully"+p.getPid(),HttpStatus.CREATED);
